...
public class Grid {
    ...
    public static ArrayList<Grid> LightningLineGrid(float Range, float offset) {
        float size = Range / 512f;
        ArrayList<Grid> g = new ArrayList<Grid>();
        Grid backgroundGrid = new Grid(2, 2, false);
        backgroundGrid.set(0, 0, 0, -30, 0.0f, 0.0f + (offset % 25) * 0.04f, 1.0f, null);
        backgroundGrid.set(1, 0, Range, -30, 0.0f, size + (offset % 25) * 0.04f, 1.0f, null);
        backgroundGrid.set(0, 1, 0, 30, 0.0f, 0.0f + (offset % 25) * 0.04f, 0.0f, null);
        backgroundGrid.set(1, 1, Range, 30, 0.0f, size + (offset % 25) * 0.04f, 0.0f, null);
        g.add(backgroundGrid);
        return g;
    }
