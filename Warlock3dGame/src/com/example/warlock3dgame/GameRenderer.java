...
import Tools.RawResourceReader;
import Tools.ShaderHelper;
import Tools.TextureHelper;
...
//import com.example.warlock3d.R;
...
public class GameRenderer implements GLSurfaceView.Renderer {
	...
	public void onSurfaceCreated(GL10 glUnused, EGLConfig config) 
	{
        ...
        // Load the texture
        mBrickDataHandle = TextureHelper.loadTexture(mActivityContext, R.drawable.characteridle);     
        GLES20.glGenerateMipmap(GLES20.GL_TEXTURE_2D);
        
        mGrassDataHandle = TextureHelper.loadTexture(mActivityContext, R.drawable.stone_wall_public_domain);
        GLES20.glGenerateMipmap(GLES20.GL_TEXTURE_2D);
