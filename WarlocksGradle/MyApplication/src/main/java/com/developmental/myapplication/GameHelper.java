...
//     * process, processes it appropriately.
    ...
    public void onActivityResult(int requestCode, int responseCode, Intent intent) {
        ...
        // connection problem. For developmental, the sign-in UI.
...
//     * necessary for sign-in to work.
    ...
    void resolveConnectionResult() {
        ...
        if (mConnectionResult.hasResolution()) {
            ...
            try {
                // launch appropriate UI flow (which might, for developmental, be the
                // sign-in flow)
...
//     * can be solved (for developmental, re-enable Google Play Services, upgrade to a
//     * new version, etc).
