...
public class Ellipse {
	...
	public boolean ArchieWithin() {
		if (WithinEllipse(Position.x, Position.y - RenderThread.size.y / 2
				- Size.y / 2, Size.x, Size.y, RenderThread.archie.feet.x,
				RenderThread.archie.feet.y)) {
			return true;
		}
		return false;
	}

	public boolean WithinEllipse(float ex, float ey, float ea, float eb,
			float px, float py) {
